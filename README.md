...
[![CI](https://github.com/MocapMax/sim_sooner/actions/workflows/ci-main.yml/badge.svg)](https://github.com/MocapMax/sim_sooner/actions/workflows/ci-main.yml)
...
<h3 align="center">sim_sooner</h3>
  ...
  <br />
  <p align="center">
    <a href="https://MocapMax.github.io/sim_sooner"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/MocapMax/sim_sooner">View Demo</a>
    ·
    <a href="https://github.com/MocapMax/sim_sooner/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    ·
    <a href="https://github.com/MocapMax/sim_sooner/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
1. Either clone the repo or download the zip file from the [project page][project-link] and extract it. 
    ```sh
    git clone https://github.com/MocapMax/sim_sooner.git  
    ```
...
_For more examples, please refer to the [Documentation](https://MocapMax.github.io/sim_sooner)._
...
See the [open issues](https://github.com/MocapMax/sim_sooner/issues) for a full list of proposed features (and known issues).

<p align="right">(<a href="#readme-top">back to top</a>)</p>


## Contributing
If you have a suggestion that would make this better, please open an issue from the [request a feature](https://github.com/MocapMax/sim_sooner/issues/new?labels=enhancement&template=feature-request---.md) or [report a bug](https://github.com/MocapMax/sim_sooner/issues/new?labels=bug&template=bug-report---.md) pages.
...
Please reach out via the [request a feature](https://github.com/MocapMax/sim_sooner/issues/new?labels=enhancement&template=feature-request---.md) or [report a bug](https://github.com/MocapMax/sim_sooner/issues/new?labels=bug&template=bug-report---.md) pages.
...
[project-link]: https://github.com/MocapMax/sim_sooner
